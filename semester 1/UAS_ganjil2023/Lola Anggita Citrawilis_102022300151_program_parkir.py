...
def Time_Count(idx):
    ...
    # duration = 89660
    if duration >= 86400:
        second = int(duration % 60)  # =20
        duration -= second  # =89640
        minute = int((duration % 3600)/60)  # =54
        duration -= (minute * 60)  # =86400
        hour = int((duration % 86400)/3600)  # = 0
        duration -= (hour * 3600)  # = 86400
        day = int(duration/86400)  # = 1
